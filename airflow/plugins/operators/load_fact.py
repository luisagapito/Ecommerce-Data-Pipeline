...
class LoadFactOperator(BaseOperator):
    copy_sql = """
    INSERT INTO {}
        (event_time,event_type,product_id,product_name,product_brand,product_price,customer_id,customer_payment_method,customer_total_charges,customer_contract)
        SELECT
                events.event_time,
                events.event_type,
                events.product_id,
                ...
                customers.contract
                FROM (SELECT distinct cast(event_time as timestamp) event_time, event_type, product_id, brand, price,user_id
            FROM {}
